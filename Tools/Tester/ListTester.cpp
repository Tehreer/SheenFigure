...
void ListTester::testInitialize()
{
    ...
    SFAssert(list.items.at == NULL);
    SFAssert(list.items.count == 0);
    SFAssert(list.items.capacity == 0);
}
...
void ListTester::testSetCapacity()
{
    ...
    SFAssert(list.items.capacity == 1024);
...
void ListTester::testReserveRange()
{
    ...
    SFAssert(list.items.count == 20);
    SFAssert(list.items.at[0] == 100);
    SFAssert(list.items.at[4] == 300);
    SFAssert(list.items.at[10] == 400);
    SFAssert(list.items.at[14] == 200);

    /* Test by reserving items at the start of the list. */
    SFListSetVal(&list, 19, 500);
    SFListReserveRange(&list, 0, 5);
    SFAssert(list.items.count == 25);
    SFAssert(list.items.at[5] == 100);
    SFAssert(list.items.at[9] == 300);
    SFAssert(list.items.at[15] == 400);
    SFAssert(list.items.at[19] == 200);
    SFAssert(list.items.at[24] == 500);
...
void ListTester::testRemoveRange()
{
    ...
    SFAssert(list.items.count == 10);
    SFAssert(list.items.at[0] == 500);
    SFAssert(list.items.at[4] == 300);
    SFAssert(list.items.at[5] == 400);
    SFAssert(list.items.at[9] == 200);
...
void ListTester::testSet()
{
    ...
    SFAssert(list.items.at[0] == 100);
    SFAssert(list.items.at[1] == 200);
    SFAssert(list.items.at[2] == 300);
    SFAssert(list.items.at[3] == 400);
    SFAssert(list.items.at[4] == 500);
...
void ListTester::testInsert()
{
    ...
    SFAssert(list.items.at[0] == 500);
    SFAssert(list.items.at[1] == 400);
    SFAssert(list.items.at[2] == 300);
    SFAssert(list.items.at[3] == 200);
    SFAssert(list.items.at[4] == 100);
...
void ListTester::testRemoveAt()
{
    ...
    SFAssert(list.items.count == 3);
    SFAssert(list.items.at[0] == 100);
    SFAssert(list.items.at[1] == 200);
    SFAssert(list.items.at[2] == 400);

    SFListRemoveAt(&list, 0);
    SFAssert(list.items.count == 2);
    SFAssert(list.items.at[0] == 200);
    SFAssert(list.items.at[1] == 400);
...
void ListTester::testTrimExcess()
{
    ...
    SFAssert(list.items.capacity == 5);
